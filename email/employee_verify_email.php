...
if(isset($_GET['key']) && isset($_GET['token'])){
    ...
    $checksign = "SELECT * FROM `joinus` WHERE `email_verification_link`='".$token."' and `email`='".$email."' ";
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        mysqli_query($conn,"UPDATE joinus set email_verified_at ='$d' WHERE email='$email'");
        $msg = "<h5 style='line-height:1.7'>Thank You for registering with the<b> Bizgrowth Organization</b>.
        <br/>We Will Contact You soon for further updates.<br/><br/><b>Thank you !</b><br/></h5>";
        $type="bg-success";
        }else{
