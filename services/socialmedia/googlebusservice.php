        ...
        <div class="modal-content" style="border-radius:10px">
            <div class="modal-body">
                <h5
                    ...
                    <b>Google My Business Requirements</b>
                </h5><br/>
                <ul class="list">
                    <li>
                ...
                <div style="text-align:right;padding:20px">
                    <button
                        type="button"
                        class="col-md-2 googlebus p-2 border-0 text-white"
                        data-bs-target="#googlebudFormModal"
